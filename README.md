# Cground
A minimal TUI application for changing desktop wallpapers with hyprpaper written in C.
...
Current state: Created bash prototype, exploring how to recreate the behavior in C before building a TUI around it
